...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $ins = $pdo->prepare("
        ...
        VALUES (?, ?, ?, ?)
    ");
    $ins->execute([$user["id"], 19, $scorePercent, $total]);

    $page_title = "Hasil Kuis Hiragana";
    require __DIR__ . "/../includes/header.php";
    ?>
<div class="card">
    <div class="card-header">
        <div class="card-title">Hasil Kuis Hiragana</div>
    </div>
    <div class="card-body">
...
$page_title = "Kuis Hiragana Dasar";
require __DIR__ . "/../includes/header.php";
?>
<div class="card">
    <div class="card-header">
        <div class="card-title">Kuis Hiragana Dasar</div>
    </div>
    <div class="card-body">
        <p>Tulislah romaji yang benar untuk setiap huruf hiragana berikut.</p>
        <form method="post">
            <table class="table">
                <thead>
                    <tr>
